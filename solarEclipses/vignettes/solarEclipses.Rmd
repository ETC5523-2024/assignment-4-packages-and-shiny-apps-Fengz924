...
This plot visualizes the eclipse events based on their longitude and latitude. Each bubble size reflects the duration of the eclipse at the respective location, and you can hover over the bubbles to get additional details.



```{r, fig.cap="Bubble plot of eclipse locations by longitude and latitude." }
...
Heatmap: State vs Eclipse Type with Duration

We can also use a scatter plot to show how the duration of eclipses varies across states for different types of eclipses.
```{r, fig.cap="Scatter plot showing the eclipse locations based on longitude and latitude."}
